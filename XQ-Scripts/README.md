...
建議同框使用：主圖戰情總覽 + 大戶攻擊力 + ADX。須綁定推薦碼 **`@GB`**。

![台指期戰情三指標示意](./images/txo_battle_overview_demo.png)

| 腳本 | 說明 |
|------|------|
| [自訂_戰情總覽V2 v1.0](./自訂_戰情總覽V2_v1.0/) | 主圖整合趨勢／主力／掛單 → 決策提示 |
| [盤中大戶即時攻擊力 v1.0](./盤中大戶即時攻擊力_v1.0/) | 內外盤淨攻擊力副圖 |
| [自訂_ADX v1.0](./自訂_ADX_v1.0/) | 強趨勢 vs 區間震盪 |

## 已發布腳本

### [自訂_戰情總覽V2 v1.0](自訂_戰情總覽V2_v1.0/)

台指期主圖戰情：ADX＋主力內外盤＋掛單差，輸出決策文字。

### [盤中大戶即時攻擊力 v1.0](盤中大戶即時攻擊力_v1.0/)

台指期分 K 副圖：即時內外盤差顯示主力偏多／偏空／觀望。

### [自訂_ADX v1.0](自訂_ADX_v1.0/)

ADX 力道線判斷強趨勢盤或區間震盪，並顯示操作提示。
