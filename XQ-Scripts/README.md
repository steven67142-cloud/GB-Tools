...
一個資料夾打包：主圖戰情總覽 + 大戶攻擊力 + ADX，以及主圖訊號 **6斤蛤蜊（5K）／6斤干貝（15K・日K）**。須綁定推薦碼 **`＠GB`**。

→ [台指期看盤介面](./台指期看盤介面/)

![台指期看盤介面示意](./台指期看盤介面/images/txo_battle_overview_demo_v2.png)

![6斤干貝蛤蜊示範圖](./台指期看盤介面/images/6斤干貝蛤蜊_demo.png)

## 已發布腳本

### [台指期看盤介面](台指期看盤介面/)

台指期分 K 看盤介面：**主圖疊圖**期貨戰情表 V1.2 精簡大字版 ＋ **副圖**大戶攻擊力 ＋ **副圖**ADX，另附今日主圖訊號 **6斤蛤蜊**（短線 5K，通道／均線預設不顯示）＋ **6斤干貝**（大波段 15K／日 K）。須綁定推薦碼 ＠GB。
