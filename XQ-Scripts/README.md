...
- **六斤蛤蜊**：短線 **5 分 K**
- **六斤干貝**：大波段 **15 分 K／日 K**
- 繪圖：主圖右鍵 → 設定 → 主圖指標 → 繪圖樣式 → 多軍空軍訊號 → 型式（點）→ 樣式（上下三角形或自訂義）

須綁定推薦碼 **`＠GB`**。

→ [六斤干貝蛤蜊](./六斤干貝蛤蜊/)

![六斤干貝蛤蜊示範圖](./六斤干貝蛤蜊/六斤干貝蛤蜊_demo.png)
...
主圖多空軍訊號兩件套：**六斤蛤蜊**（短線 5K）＋ **六斤干貝**（大波段 15K／日 K）。須綁定推薦碼 ＠GB。

### [台指期看盤介面](台指期看盤介面/)

台指期分 K 看盤介面三件套：**主圖疊圖**期貨戰情表 V1.2 精簡大字版 ＋ **副圖**大戶攻擊力 ＋ **副圖**ADX。建議在15分K週期使用。V1.2 版面精簡、字體加大，邏輯同 v1.1（趨勢／主力／量能 → 決策）。
