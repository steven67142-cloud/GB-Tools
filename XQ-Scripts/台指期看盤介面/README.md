...
| `6斤蛤蜊_5K_v1.0_推薦碼GB.xsb` | **主圖訊號**：短線 5 分 K 多空軍 |
| `6斤干貝_15分K日K_v1.0_推薦碼GB.xsb` | **主圖訊號**：大波段 15 分 K／日 K 多空軍 |
| `txo_battle_overview_demo_v2.png` | 戰情表同框示意圖 |
| `6斤干貝蛤蜊_demo.png` | 蛤蜊／干貝示範圖（5K／15K／日K） |

## 安裝方式

1. 下載戰情表、大戶攻擊力、ADX，以及6斤蛤蜊／6斤干貝 `.xsb`
